<div class="space-y-6">
    ...
    <div
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Organiza tus noticias por temas y define sus estilos
                visuales.</p>
        </div>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-50 dark:border-gray-800">
                        ...
                        @if (auth()->user()->role !== 'user')
                            <div class="flex gap-4">
                                ...
                                <button wire:click="delete({{ $category->id }})" wire:confirm="¿Seguro?"
    ...
    @if ($showModal)
        <div class="fixed inset-0 z-[100] overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div
                    class="relative bg-white dark:bg-gray-900 w-full max-w-lg rounded-sm shadow-2xl border-t-4 border-brand-600 overflow-hidden">
                    <div
                        ...
                        <h3 class="text-xl font-serif font-bold">
                            {{ $categoryId ? 'Editar Categoría' : 'Nueva Sección' }}</h3>
                    ...
                    <div class="p-8 space-y-6">
                        <div>
                            <label
                                class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Nombre</label>
                        ...
                        <div>
                            <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Ruta
                                Única (Slug)</label>
                            <input type="text" wire:model="slug"
                                class="w-full bg-gray-50 dark:bg-gray-800 border-none rounded-sm text-xs p-3 text-gray-500">
                        </div>
                        <div>
                            <label
                                class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Descripción</label>
                            <textarea wire:model="description" rows="3"
                                class="w-full bg-gray-50 dark:bg-gray-800 border-none rounded-sm text-xs p-3"></textarea>
                        </div>
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                <label
                                    class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Color</label>
                                <input type="color" wire:model="color"
                                    class="h-10 w-full border-none rounded-sm cursor-pointer p-0 bg-transparent">
                            </div>
                            <div>
                                <label
